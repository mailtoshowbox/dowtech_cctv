...
class ControllerCheckoutEnquiry extends Controller {
	public function index() {
		...
		$this->response->setOutput($this->load->view('checkout/enquiry', $data));
	}
	...
	public function save() {
		...
		if (!$json) {
			...
			$customer_group_id = ENQUIRY_CUSTOMER;
 ...
 $redirect = '';
		...
		if (!$redirect) {
			...
			if (isset($this->session->data['comment'] )) {
				$order_data['comment'] = $this->session->data['shipping_method']['code'];
			} else {
				$order_data['comment'] = 'Enquiry Order';
			}
			...
			$order_data['order_status_id'] = ENQUIRY_ORDER;
			...
			$this->session->data['order_id'] = $this->model_checkout_order->addOrderEnquiry($order_data);
			...
			$json['redirect'] =  $this->url->link('checkout/successenquiry', '', true);			 
		} else {
